...
#define AI_NETWORK_MODEL_SIGNATURE     "0x8e7957486051a10374b0627267177043"
...
#define AI_TOOLS_DATE_TIME   "2025-10-31T19:02:37+0530"
...
/* Array#1 */
AI_ARRAY_OBJ_DECLARE(
  _net_net_0_Gemm_output_0_output_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#3 */
AI_ARRAY_OBJ_DECLARE(
  _net_net_2_Gemm_output_0_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 32, AI_STATIC)
...
/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
  _net_net_0_Gemm_output_0_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 320, AI_STATIC)

/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  _net_net_0_Gemm_output_0_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 32, AI_STATIC)

/* Array#8 */
AI_ARRAY_OBJ_DECLARE(
  _net_net_2_Gemm_output_0_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 1024, AI_STATIC)

/* Array#9 */
AI_ARRAY_OBJ_DECLARE(
  _net_net_2_Gemm_output_0_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 32, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 1), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &_net_net_0_Gemm_output_0_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, &_net_net_0_Gemm_output_0_weights_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 1), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &_net_net_2_Gemm_output_0_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, &_net_net_2_Gemm_output_0_weights_array, NULL)
...
AI_LAYER_OBJ_DECLARE(
  _net_net_2_Gemm_output_0_layer, 3,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
...
AI_LAYER_OBJ_DECLARE(
  _net_net_0_Gemm_output_0_layer, 1,
  DENSE_TYPE, 0x0, NULL,
  dense, forward_dense,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 6028, 1, 1),
    6028, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &_net_net_0_Gemm_output_0_layer, 0xaa1eb9b0, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    _net_net_0_Gemm_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    _net_net_0_Gemm_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    _net_net_1_Relu_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    _net_net_1_Relu_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    _net_net_2_Gemm_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    _net_net_2_Gemm_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    _net_net_3_Relu_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    _net_net_3_Relu_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    _net_net_0_Gemm_output_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 1280);
    _net_net_0_Gemm_output_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1280);
    _net_net_2_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _net_net_2_Gemm_output_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 1408);
    _net_net_2_Gemm_output_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1408);
    _net_net_2_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _net_net_2_Gemm_output_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 5504);
    _net_net_2_Gemm_output_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5504);
    logits_weights_array.format |= AI_FMT_FLAG_CONST;
    logits_weights_array.data = AI_PTR(g_network_weights_map[0] + 5632);
    logits_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 5632);
    logits_bias_array.format |= AI_FMT_FLAG_CONST;
    logits_bias_array.data = AI_PTR(g_network_weights_map[0] + 6016);
    logits_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 6016);
    return true;
  }
